...
orderlines_joined_tbl %>% glimpse()

# 5.0 Wrangling Data ----

orderlines_wrangled_tbl <- orderlines_joined_tbl %>% 
  ...
  bind_cols(orderlines_joined_tbl %>% select(order.id)) %>% 
...
# Step 1 - Manipulate
sales_by_year_tbl <- orderlines_wrangled_tbl %>%
...
sales_by_year_cat_1_tbl <- orderlines_wrangled_tbl %>%
...
bike_orderlines_wrangled_tbl %>%
  write_xlsx("cm_data/02_wrangled_data/bike_orderlines.xlsx")

# 7.2 CSV ----
bike_orderlines_wrangled_tbl %>% 
  write_csv("cm_data/02_wrangled_data/bike_orderlines.csv")

# 7.3 RDS ----
bike_orderlines_wrangled_tbl %>% 
  write_rds("cm_data/01_bike_sales/02_wrangled_data/bike_orderlines.rds")
